...
void clipTriangle(const TriangleData &tri, TriangleData &out);
...
void getDrawableTriangles(const TriangleData &triangleData, const Transform &transform, TriangleData &outTris, bool multithread = true);
